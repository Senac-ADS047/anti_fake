    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sala', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='antifake.sala')),
            ],
        ),
        migrations.CreateModel(
            name='Tarefa',
            fields=[
                ...
                ('aula', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='antifake.aulasemanal')),
